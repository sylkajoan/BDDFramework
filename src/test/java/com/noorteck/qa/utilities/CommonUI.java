...
public class CommonUI extends GlobalVariables {
	...
	public static void openBrowser() {
		...
		try {
			if(browser.equals("chrome")) {
				System.setProperty(
						prop.getProperty("chromeName"), prop.getProperty("chromePath"));
				...
				Assert.fail("Unable to find browser, Check EnvironmentData.properties file");
			}
			
		}catch (Exception e) {
			e.printStackTrace();
			Assert.fail("Unableto find browser, Check EnvironementData.properties file");
		}
	}
	...
	public static void clear(WebElement element) {
		try {
			...
			System.out.println("WebElementnot found " + e);
			e.printStackTrace();
		}
	}
	...
	/**
	 * This method takes two parameters and then performs clear and enter actions in page
	 * @param element
	 * @param value
	 */
	...
	/**
	 * This method takes element and returns the title of the page
	 * @param element
	 * @return
	 */
	...
	/**
	 * This method takes two parameters and selects value from drop-down based on index number
	 * @param element
	 * @param index
	 */
	...
	/**
	 * This method takes two parameters and selects value from drop-down based on value
	 * @param element
	 * @param value
	 */
	...
	/**
	 * This method takes two parameters and selects value from drop-down based on Visible Text
	 * @param element
	 * @param visibleText
	 */
	public static void dropDownByIndex(WebElement element, String visibleText) {
		try {
			Select dropdown = new Select(element);
